...
export const getShopProduct = (token, id) => ({
  type: GET_SHOP_PRODUCT,
  payload: { token, id },
});

export const getShopProductSuccess = (data) => ({
  type: GET_SHOP_PRODUCT_SUCCESSFUL,
  payload: { data },
});

// charts data
export const getShopProductFail = (data) => ({
  type: GET_SHOP_PRODUCT_FAILED,
  payload: { data },
});